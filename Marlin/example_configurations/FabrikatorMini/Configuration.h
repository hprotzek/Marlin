...
#define STRING_CONFIG_H_AUTHOR "(hprotzek, FabMini_1.5 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FabMini_1.5"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "ef184f07-db3e-436f-8c73-540c69f181c0"
...
//  #define  DEFAULT_bedKd 305.4
  ...
  #define  DEFAULT_bedKi 46.59
  #define  DEFAULT_bedKd 304.40
#endif // PIDTEMPBED
